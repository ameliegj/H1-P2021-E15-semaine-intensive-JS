$(document).ready(function () {
  ...
  var ennemies = $(".ennemy"), //ennemies
      shoot = $(".shoot"), //shoot
      slash = $(".slash"), //and slash
      vitessePerso = 10, //perso speed
...
function slashEnnemies(slash, ennemies) { //détruire ennemis si le slash le touche
  ennemies.each(function (index) {
    if ((((parseInt(slash.css("left")) >= parseInt($(this).css("left")) && parseInt(slash.css("left")) <= parseInt($(this).css("left")) + 40)) && (parseInt(slash.css("top")) >= parseInt($(this).css("top")) && parseInt(slash.css("top")) <= parseInt($(this).css("top")) + 20)) || ((((parseInt(slash.css("left")) + 40) >= parseInt($(this).css("left")) && (parseInt(slash.css("left")) + 20) <= parseInt($(this).css("left")) + 20)) && ((parseInt(slash.css("top")) + 10) >= parseInt($(this).css("top")) && (parseInt(slash.css("top")) + 10) <= parseInt($(this).css("top")) + 20))) {
